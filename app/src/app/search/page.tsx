...
export default async function SearchPage({ searchParams }: PageProps) {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      <header className="border-b border-ink-200 dark:border-ink-700/50 px-6 py-3">
        <div className="max-w-6xl mx-auto flex items-center gap-6">
          <Link
            href="/"
            className="font-serif text-xl tracking-tight whitespace-nowrap shrink-0"
          >
      ...
      <div className="flex-1 px-6 py-6">
        <div className="max-w-6xl mx-auto">
          {q ? (
            ...
            <p className="font-serif italic text-ink-500 py-12 text-center">
